...
def build_report(file_stream, data):
    import json
    html_final = html.replace(r"${resultData}", json.dumps(data, ensure_ascii=False, indent=4))
    file_stream.write(html_final.encode('utf8'))
